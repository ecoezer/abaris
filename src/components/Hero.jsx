            ...
            <div className="w-2/3 pt-1 md:pt-2 lg:pt-0 px-2 md:px-3 flex flex-col justify-start items-center">
              <div className="text-center w-full">
                <h1 className="text-white font-bold mb-2 md:mb-2 flex flex-col items-center">
                  <div className="relative text-5xl sm:text-7xl md:text-8xl lg:text-[150px] leading-none tracking-wide inline-block font-light font-helvetica">
                    Abar
              ...
              {/* Feature Cards */}
              <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 gap-2 md:gap-3 w-full pb-3 md:pb-0 pt-2 md:pt-3">
                {/* Qualität */}
...
und Eleganz, die bleibt.
                ...
                <div className="flex flex-col items-center text-center group h-full">
                  ...
                  <h3 className="text-white text-lg md:text-base lg:text-[1.3rem] font-light mb-1 md:mb-1 lg:mb-2 transition-all duration-300 group-hover:scale-105">Abaris Nachhaltigkeit – Sauberkeit mit Verantwortung</h3>
                  <p className="text-white font-light text-xs md:text-xs lg:text-sm leading-relaxed opacity-90">
