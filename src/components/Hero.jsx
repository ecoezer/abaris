            ...
            <div className="w-2/3 pt-2 md:pt-4 px-4 md:px-8 flex flex-col justify-center items-start">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-8 w-full">
                ...
                <div className="flex flex-col items-center text-center group">
                  ...
                  <h3 className="text-white text-lg md:text-xl lg:text-2xl font-light mb-2 md:mb-3 lg:mb-4 transition-all duration-300 group-hover:scale-105">Qualität</h3>
                ...
                <div className="flex flex-col items-center text-center group">
                  ...
                  <h3 className="text-white text-lg md:text-xl lg:text-2xl font-light mb-2 md:mb-3 lg:mb-4 transition-all duration-300 group-hover:scale-105">Service</h3>
                  <p className="text-white font-light text-xs md:text-sm leading-relaxed opacity-90">
                ...
                <div className="flex flex-col items-center text-center group">
                  ...
                  <h3 className="text-white text-lg md:text-xl lg:text-2xl font-light mb-2 md:mb-3 lg:mb-4 transition-all duration-300 group-hover:scale-105">Nachhaltigkeit</h3>
                  <p className="text-white font-light text-xs md:text-sm leading-relaxed opacity-90">
