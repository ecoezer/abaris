        ...
        <div className="max-w-7xl mx-auto px-4 md:px-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-20">
            ...
            <div className="space-y-6 md:space-y-8">
              {/* Büroreinigung */}
              <div className="flex items-center justify-between pb-4 md:pb-6 border-b border-gray-200 hover:border-abaris-cyan transition-colors cursor-pointer">
              ...
              {/* Grundreinigung */}
              <div className="flex items-center justify-between pb-4 md:pb-6 border-b border-gray-200 hover:border-abaris-cyan transition-colors cursor-pointer">
                <h3 className="text-lg md:text-xl font-light text-gray-900">Grundreinigung</h3>
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" className="text-gray-400 flex-shrink-0">
                  <path d="M5 12h14M12 5l7 7-7 7"/>
                </svg>
              </div>
              ...
              {/* Haushaltsreinigung */}
              <div className="flex items-center justify-between pb-4 md:pb-6 border-b border-gray-200 hover:border-abaris-cyan transition-colors cursor-pointer">
                <h3 className="text-lg md:text-xl font-light text-gray-900">Haushaltsreinigung</h3>
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" className="text-gray-400 flex-shrink-0">
                  <path d="M5 12h14M12 5l7 7-7 7"/>
                </svg>
              </div>

              {/* Reinigungsservice COVID-19 */}
              <div className="flex items-center justify-between pb-4 md:pb-6 border-b border-gray-200 hover:border-abaris-cyan transition-colors cursor-pointer">
                <h3 className="text-lg md:text-xl font-light text-gray-900">Reinigungsservice COVID-19</h3>
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" className="text-gray-400 flex-shrink-0">
                  <path d="M5 12h14M12 5l7 7-7 7"/>
                </svg>
              </div>
