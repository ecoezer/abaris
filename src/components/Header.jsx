...
function Header() {
  ...
  return (
    <header className={`fixed -top-6 left-0 right-0 z-50 transition-colors duration-300 ${isScrolled ? 'bg-abaris-cyan' : ''}`}>
      <div className="max-w-7xl mx-auto px-4 md:px-8 py-0.5 md:py-0.5">
        <div className="flex items-center justify-between">
          <div className="text-white text-2xl md:text-3xl font-light tracking-wide cursor-pointer leading-none" onClick={() => scrollToSection('hero')}>
            Abaris
          </div>
